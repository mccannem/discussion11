...
// Question 1
document.getElementById("host-name").innerHTML = "Emily McCann";
document.getElementById("collaborator-name").innerHTML = "Rachel Sonnett";
...
let hideButton = document.querySelector("instruction-button");
hideButton.addEventListener("click", hideInstructions());

function hideInstructions() {
    let questions = document.querySelectorAll(".questions");
    for (let i = 0; i < array.length; i++) {
        questions[oi].stylee.display = "None";
     }     
}
...
function autoPopulateLastName(firstNameValue) {
    const lastNameInput = document.getElementById('lastName');
    if (firstNameValue.toLowerCase() === 'John') {
